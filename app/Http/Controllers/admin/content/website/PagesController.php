...
namespace App\Http\Controllers\admin\content\website;
    ...
    public function columns($id = '')
    {
        $columns = [
            'Title' => [
                ...
                'validation' => 'required|max:255|unique:public_pages,title' . ($id != '' ? ',' . $id : ''),
            ],
            'Route' => [
                'name' => 'route',
                'type' => 'route',
                'index' => 1, 'show' => 1, 'edit' => 1, 'search' => 'string',
                'validation' => 'required|max:255|unique:public_pages,route' . ($id != '' ? ',' . $id : ''),
            ],
            'Content' => [
                'name' => 'content',
                'type' => 'longtext',
